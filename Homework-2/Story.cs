...
namespace Fairy_tale
{
    class Story
    {
        ...
        public void Start()
        {
            ...
            good.Defence = randomizer.Rand(10, 50);
            good.Attack = randomizer.Rand(15, 60);
            bad.Name = "Dart Vader";
            bad.Attack = randomizer.Rand(10, 50);
            bad.Defence = randomizer.Rand(15, 60);
